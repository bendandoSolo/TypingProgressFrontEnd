...
const LineChart1 = (data: any) => {
  ...
  useEffect(() => {
    if (lineChart1.current) {
      ...
      accuracy = accuracy.map((a: any) => parseInt(a)).filter((a: any) => !isNaN(a));
      console.log('accuracy', accuracy);
      let movingAccuracy = movingAverageCalculator(accuracy, 10);
        ...
        chart = new Chart(lineChart1.current, {
          ...
          data: {
            ...
            datasets: [
              ...
              {
                label: 'Accuracy Moving Average' + movingAverageDays + ' days',
                data: movingAccuracy,
                fill: false,
